...
HD_PWD='/users/yyang22/thesis/aegnn_project/vivado_dir/sys_acc/sys_acc.runs/top_bd_top_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_bd_top_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_bd_top_0_0.tcl
