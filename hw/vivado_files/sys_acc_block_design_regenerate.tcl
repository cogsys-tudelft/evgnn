...
\
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M00_AXI [get_bd_intf_pins ps8_0_axi_periph/M00_AXI] [get_bd_intf_pins top_0/S_AXI]
  connect_bd_intf_net -intf_net top_0_M_AXI [get_bd_intf_pins top_0/M_AXI] [get_bd_intf_pins axi_smc/S00_AXI]
  ...
  connect_bd_net -net rst_ps8_0_99M_peripheral_aresetn [get_bd_pins rst_ps8_0_99M/peripheral_aresetn] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins axi_smc/aresetn] [get_bd_pins top_0/rstn]
  connect_bd_net -net top_0_fc_out_pack [get_bd_pins top_0/fc_out_pack] [get_bd_pins ila_0/probe4]
  connect_bd_net -net top_0_ip_clean [get_bd_pins top_0/ip_clean] [get_bd_pins ila_0/probe6]
  connect_bd_net -net top_0_ip_clear [get_bd_pins top_0/ip_clear] [get_bd_pins ila_0/probe2]
  connect_bd_net -net top_0_ip_done [get_bd_pins top_0/ip_done] [get_bd_pins ila_0/probe1]
  connect_bd_net -net top_0_ip_en [get_bd_pins top_0/ip_en] [get_bd_pins ila_0/probe5]
  connect_bd_net -net top_0_ip_idle [get_bd_pins top_0/ip_idle] [get_bd_pins ila_0/probe0]
  connect_bd_net -net top_0_new_event [get_bd_pins top_0/new_event] [get_bd_pins ila_0/probe7]
  connect_bd_net -net top_0_prediction [get_bd_pins top_0/prediction] [get_bd_pins ila_0/probe3]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps8_0_99M/slowest_sync_clk] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins axi_smc/aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihp0_fpd_aclk] [get_bd_pins top_0/clk] [get_bd_pins ila_0/clk]
  ...
  assign_bd_address -offset 0xA0000000 -range 0x00001000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs top_0/S_AXI/reg0] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces top_0/M_AXI] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_LOW] -force
  assign_bd_address -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces top_0/M_AXI] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_LPS_OCM] -force
  assign_bd_address -offset 0xC0000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces top_0/M_AXI] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_QSPI] -force
